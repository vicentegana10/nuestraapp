...
ActiveRecord::Schema.define(version: 2021_06_22_232919) do
  ...
  create_table "lodgings_services", id: false, force: :cascade do |t|
  ...
  create_table "stays", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.integer "lodging_id"
    t.index ["lodging_id"], name: "index_stays_on_lodging_id"
  ...
  add_foreign_key "stays", "lodgings"
